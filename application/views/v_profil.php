      ...
      <form action="<?= base_url('Profil/edit') ?>" method="post" enctype="multipart/form-data" role="form">
        <div class="modal-body">
          ...
          <div class="form-group mb-3">
            ...
            <input class="form-control" id="nisn" name="nisn" placeholder="Masukkan NISN" type="text" value="<?= $info['nisn'] ?>" required="" disabled oninvalid="this.setCustomValidity('NISN Belum Terisi!')" oninput="setCustomValidity('')"></input>
          </div>
          <div class="form-group mb-3">
